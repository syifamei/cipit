...
<div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Masuk ke akun Pusat Bantuan BAPPERIDA Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('user.login.submit') }}" class="space-y-4">
            ...
            <!-- Submit Button -->
            <button type="submit" 
                    class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-lg font-semibold transition transform hover:scale-[1.02] shadow-lg">
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-600">
                Belum punya akun? 
                <a href="{{ route('user.register') }}" class="font-medium text-blue-600 hover:text-blue-700">Daftar sekarang</a>
            </p>
        </div>
    </div>
